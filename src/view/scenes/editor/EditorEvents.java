...
public class EditorEvents {
    ...
    /**
     * Prompts a user to save their current controller.editor state on attempted exit from
     * the controller.editor
     *
     * @param newEditor is true if a new controller.editor instance should be created, false
