...
import view.media.SnapShot;
import view.media.SoundPlayer;
 ...
 *         <p>
 *         This class initializes model.player status ui.
 */
public class EngineSidePanel implements Observer {
    ...
    /**
     * Creates the tab-based menu that will hold the ui.scenes.controller.editor.objects to be added to the
     * overworld model.grid.
     *
