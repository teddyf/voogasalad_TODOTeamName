...
public class FileBrowser {
    ...
    private FileChooser setUpEditorFileChooser(String path) {
        ...
        FileChooser.ExtensionFilter filter = new FileChooser.ExtensionFilter("EDITOR files (*.controller.editor)", "*.controller.editor");
    ...
    private FileChooser setUpEngineFileChooser(String path) {
        FileChooser browser = new FileChooser();
        FileChooser.ExtensionFilter filter = new FileChooser.ExtensionFilter("ENGINE files (*.controller.engine)", "*.controller.engine");
        browser.getExtensionFilters().add(filter);
        browser.setInitialDirectory(new File(path));
        return browser;
    }
