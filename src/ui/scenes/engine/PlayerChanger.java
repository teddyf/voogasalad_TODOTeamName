...
public class PlayerChanger {
	...
	private void addPlayerOptions() {
		...
		String path1 = "resources/images/sprites/Character/Pokemon/Player1SouthFacing.png";
		Button button1 = new Button();
		button1.setGraphic(new ImageView(new Image(path1)));
		button1.setOnMouseClicked(e -> player.changeCharacterImage(path1));
		
		String path2 = "resources/images/sprites/Character/Pokemon/Player2SouthFacing.png";
